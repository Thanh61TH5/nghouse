        ...
        <section>
            ...
            <div className={"flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto"}>
                ...
                <div className={"w-full md:w-[67%] lg:w-[40%] mb-12 lg:ml-20"}>
                    < form >
                        <input className={"w-full px-4 py-2 mb-5 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"} type="email" id ="email" value={email} onChange={onChange} placeholder="Email"/>
                    </form>
